...
const CardWithOverlayWithMemoryLeak: React.FC<ContainerProps> = ({ hideCard }) => {
    ...
    return (
        ...
        <IonCard  button={true} onClick={() => showNotificationInformation()}>
            ...
            <IonItem lines="none" >
                <IonLabel >Clicking on it will open the modal that is used as a component. This gives a memory leak</IonLabel>
            </IonItem>
        </IonCard>
...
export default CardWithOverlayWithMemoryLeak;